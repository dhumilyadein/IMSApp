    ...
    try {
      ...
      if (event.target.name === "file")
        ...
        this.setState(
          ...
          () => console.log("zipfile:  " + this.state.zipFile.name)
        );
    } catch (err) {
      console.log(
                ...
                <CardBody className="p-4">
                  <Form>
                    ...
                    {this.state.impSuccess && (
                      ...
                      >
                        <ModalHeader toggle={this.toggleSuccess}>
                          Excel sheet {this.state.filename} Imported
                          Successfully!
                        </ModalHeader>
                      </Modal>
                    )}
                      ...
                      <InputGroupAddon addonType="prepend">
                        <div>
                          ...
                          <font color="red">
                            ...
                            <h6>
                              {" "}
                              Please make sure the number of Records in Excel
                              sheet matches the total number of Photos in zip
                              file.
                            </h6>{" "}
                          </font>
                          <font color="red">
                            <h6>
                              {" "}
                              Please make sure each Photo's name matches the
                              Username in the Excel sheet.
                            </h6>
                          </font>
                          <font color="red">
                            {" "}
                            <h6>
                              {" "}
                              Please make sure Photos.zip contains only JPG
                              format photos and no Folder(s).
                            </h6>
                          </font>
                          <font color="red">
                            {" "}
                            <h6>
                              {" "}
                              Please make sure Fee Templates, Student's Class &
                              Section entered in the sheet, are available before
                              Importing Users.{" "}
                            </h6>
                          </font>
                          <font color="red">
                            <h6>
                              {" "}
                              If you face any unexpected behaviour, click Reset
                              or Refresh your browser's tab and try again.
                            </h6>
                          </font>
                          <br />
                        </div>
                    ...
                    {this.state.noFile && (
                      <font color="red">
                        {" "}
                        <h5>Please choose the Excel file</h5>
                      </font>
                    )}
                    ...
                    {this.state.corruptFile && (
                      <font color="red">
                        {" "}
                        <h5>Please select a valid XLS or XLSX file only.</h5>
                      </font>
                    )}
                    ...
                    {this.state.noZipFile && (
                      <font color="red">
                        {" "}
                        <h5>Please choose the Photos Zip file</h5>
                      </font>
                    )}
                    ...
                    {this.state.corruptZipFile && (
                      <font color="red">
                        {" "}
                        <h5>Please select a valid Zip file only.</h5>
                      </font>
                    )}
                      ...
                      <Row className="align-items-center">
                        <Col col="6" sm="2" md="2" xl className="mb-3 mb-xl-0">
                          <font color="red">
                            ...
                            <p>
                              {Object.keys(this.state.importErrors).length}{" "}
                              record(s) failed to import. For errors, click
                              Errors
                            </p>
                          </font>
                          <Button
